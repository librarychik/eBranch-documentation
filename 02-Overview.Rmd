...
-   Workshops
-   Other miscellaneous pages, such as: Librarian and other [Library Position Openings](https://www.lib.sfu.ca/about/overview/employment/librarian-jobs)
...
1.  Create a News & Events item describing the problem, e.g. Library
    ...
    > Catalogue](https://sfu-primo.hosted.exlibrisgroup.com/primo-explore/search?vid=SFUL&sortby=rank)
    > to find your resources.

2.  If a Multisearch/Library Search problem, go to the Multisearch Admin
    > Tool and select Notices; either
